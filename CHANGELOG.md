...
## [2.0.0](https://github.com/rknightion/transceiver-exporter/compare/v1.6.0...v2.0.0) (2026-09-26)
...
* adopt canonical routing and bounded root rescue ([828d4b0](https://github.com/rknightion/transceiver-exporter/commit/828d4b073acf86180ed12f19f85e183ab9f5fdc4))
* **agents:** review fix transceiver-exporter AGENTS.md ([3e00508](https://github.com/rknightion/transceiver-exporter/commit/3e00508118702e87045c376295856c40b060fec7))
* **agents:** transceiver-exporter to AGENTS.md standard ([6bf29a1](https://github.com/rknightion/transceiver-exporter/commit/6bf29a19e2329886d2ad54dfaa8a8a22e0d0b12a))
* align recovery contracts and compaction evidence ([f1c61d8](https://github.com/rknightion/transceiver-exporter/commit/f1c61d8192cd0da7927c714482465db106635c01))
...
* publish canonical agent documents ([9ca9178](https://github.com/rknightion/transceiver-exporter/commit/9ca9178a6fe6838434691a7f2e5606ff7af64373))
* publish canonical agent documents ([255cd48](https://github.com/rknightion/transceiver-exporter/commit/255cd482283aa3cab0153caa8856a94b3cfd0bce))
* publish canonical agent documents ([0431385](https://github.com/rknightion/transceiver-exporter/commit/0431385402644252916434697850a9a323ce7110))
* publish canonical agent documents ([1db8e40](https://github.com/rknightion/transceiver-exporter/commit/1db8e40e97077974da5a0cec0ee813a8af60af3e))
* publish canonical agent documents ([1e97e9b](https://github.com/rknightion/transceiver-exporter/commit/1e97e9bf3e2fc39523da5ea1765ef4105ef78dce))
* publish canonical agent documents ([23aa26e](https://github.com/rknightion/transceiver-exporter/commit/23aa26e2be244dbe4749ed9e0ffb1cc25607b62b))
* publish canonical agent documents ([60142e1](https://github.com/rknightion/transceiver-exporter/commit/60142e1b2ab22cce9986158f490dd2759c553ac6))
* publish canonical agent documents ([0592f07](https://github.com/rknightion/transceiver-exporter/commit/0592f07bcc928d13ebf96dda2b542caed8f6d649))
* publish canonical agent documents ([70dc4af](https://github.com/rknightion/transceiver-exporter/commit/70dc4afc77d4f72361f62996c91c4f33ceb1fadf))
* publish canonical agent documents ([90ab625](https://github.com/rknightion/transceiver-exporter/commit/90ab625be29218a31ec69a9d476d5ae57ff75501))
* publish canonical agent documents ([a764087](https://github.com/rknightion/transceiver-exporter/commit/a7640870cbd7710c16aa339613a5d25b3f6e1a3d))
* publish canonical agent documents ([800bcc5](https://github.com/rknightion/transceiver-exporter/commit/800bcc5b7f0a3dd631b83cfab9b6e0ab7681562c))
* publish canonical agent documents ([8fd9b10](https://github.com/rknightion/transceiver-exporter/commit/8fd9b1029be57aa3d5abb07a3698ac3765cc6761))
* publish canonical agent documents ([9106bff](https://github.com/rknightion/transceiver-exporter/commit/9106bff49945298a87dd915b92528e2e24b6c539))
* publish canonical agent documents ([99e30b6](https://github.com/rknightion/transceiver-exporter/commit/99e30b64162bc31fc376e7502ba0a2269e209fde))
* publish canonical agent documents ([b939b84](https://github.com/rknightion/transceiver-exporter/commit/b939b848c3dfb2f757e165da092098715fce48e6))
* publish canonical agent documents ([5fc116b](https://github.com/rknightion/transceiver-exporter/commit/5fc116b204e2b054592bc471d922c08d3dfd003f))
* publish public Backlog workspace ([92df5c9](https://github.com/rknightion/transceiver-exporter/commit/92df5c94b14e3f6bcb3f7d17e43b001f67dae3d7))
...
* sync approved fan-out scheduling and route verification ([f7620a7](https://github.com/rknightion/transceiver-exporter/commit/f7620a729bf5ace3dc00fb4559283c19e97ebc28))
...
* sync authorised Astra root judgement ([db36876](https://github.com/rknightion/transceiver-exporter/commit/db368761c9635b88b9aa72609671d6d18f79706f))
* sync cost-aware fan-out routing and prompt guidance ([3d8c251](https://github.com/rknightion/transceiver-exporter/commit/3d8c251453f9109291b0a7fbbf4233714e05d27d))
* sync fan-out async decision-only guidance ([b8eb328](https://github.com/rknightion/transceiver-exporter/commit/b8eb328c5b8678452b03af5fd8f1c98f33c1c2a2))
* sync fan-out protocol from agent-docs ad7abd2 ([b1807fb](https://github.com/rknightion/transceiver-exporter/commit/b1807fb1eea1907d6c9790dfe64c7418eef93c8c))
* sync fan-out protocol, delegated root authority for unattended runs ([3c6f20e](https://github.com/rknightion/transceiver-exporter/commit/3c6f20e2ebbc73e399ff8ec4f20db29fd0c5ab39))
* sync fan-out protocol, explicit add does not bound the commit ([de4fbab](https://github.com/rknightion/transceiver-exporter/commit/de4fbab4aca2fd9188659c05ca35d56c9fe95800))
* sync fixed Astra low orchestration and rescue routing ([ea17d7a](https://github.com/rknightion/transceiver-exporter/commit/ea17d7abaa16a033d8551c4e50d097242c51f262))
...
* sync polling and integration contracts ([f705017](https://github.com/rknightion/transceiver-exporter/commit/f7050176c5eaf4259368b99251beffdd865cefd0))
* sync root async question policy ([c54215a](https://github.com/rknightion/transceiver-exporter/commit/c54215a1e94cac2fdcc1dd00f11612fbab247032))
* sync same-session fan-out recovery contract ([d378258](https://github.com/rknightion/transceiver-exporter/commit/d378258126c3c8cdf0c49b552bd7f6ec72eab440))
* sync wave orchestration and existing-root contracts ([3522761](https://github.com/rknightion/transceiver-exporter/commit/3522761075c0f9f349cf18ef5c3f84763aa2f649))
* sync wave reliability and worktree contracts ([470b657](https://github.com/rknightion/transceiver-exporter/commit/470b6574b0ec1d33bd771e83c8df311745d0cce3))
...
* move the Go toolchain pin to 1.27.1 ([5d6147c](https://github.com/rknightion/transceiver-exporter/commit/5d6147cc4da3d0df274765a66ae75fab580c4a5d))
